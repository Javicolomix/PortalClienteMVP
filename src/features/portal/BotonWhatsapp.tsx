...
const CLASES_DEL_BOTON =
  "group flex size-[52px] items-center justify-center rounded-full bg-[#25d366] text-white transition-transform duration-150 ease-out [-webkit-tap-highlight-color:transparent] active:scale-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring md:size-[58px]";
