    ...
    <div className="overflow-hidden rounded-lg bg-card ring-1 ring-border-subtle">
      <h3>
        ...
        >
          ...
          {/* El nivel, con la fila cerrada: **una palabra** en su pastilla. Con
              dos o tres causas abiertas la pregunta es «cuál de todas me pide
              algo», y eso se compara de un vistazo; una frase en cada fila
